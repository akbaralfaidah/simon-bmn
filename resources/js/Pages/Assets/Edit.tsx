...
export default function Edit({ auth, asset, categories, rooms }: any) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        is_loanable: Boolean(asset.is_loanable),
    ...
    return (
        <AuthenticatedLayout header="Edit Aset BMN">
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <form onSubmit={submit}>
                    ...
                    <InputError message={errors.version} className="mb-4" />
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input id="item_code" className={inputClass} value={data.item_code} readOnly />
                                        <InputError className="mt-1.5" message={errors.item_code} />
                                    </div>
                                    <div>
                                        <label htmlFor="nup" className={labelClass}>NUP</label>
                                        <input id="nup" className={inputClass} value={data.nup} readOnly />
                                        <InputError className="mt-1.5" message={errors.nup} />
                                    </div>
                                </div>

                                <div><label htmlFor="satker_code" className={labelClass}>Kode satker</label><input id="satker_code" className={inputClass} value={data.satker_code} readOnly /><InputError message={errors.satker_code} /><p className="mt-2 text-xs text-slate-500">Perubahan identitas melalui <Link className="underline" href={route('workspace.index', 'registers')}>register ASP/PSP</Link>, dengan bukti dan review independen.</p></div>
                                <div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div>
                                            ...
                                            <select id="room_id" className={selectClass} value={data.room_id} disabled>
                                            ...
                                            <p className="mt-2 text-xs text-slate-500">Pemindahan barang dilakukan lewat menu Mutasi ruangan. Aset tanpa ruangan ditempatkan melalui Administrasi → Penempatan awal.</p>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-brand-primary/40 transition-colors">
                                    ...
                                    <label htmlFor="images" className="cursor-pointer">
                                        <span className="text-sm font-semibold text-brand-primary hover:text-brand-primaryLight">Tambahkan foto baru</span>
                                        <span className="text-sm text-gray-500"> atau seret ke sini</span>
                                    </label>
                                    <p className="text-xs text-gray-400 mt-1.5">Foto baru akan ditambahkan ke foto aset yang sudah ada.</p>
                                </div>
