...
<head>
    ...
    <title>Pemberitahuan Penghapusan Akun - SIMON BMN Gakkum</title>
    <style type="text/css">
        ...
        <tr>
            <td align="center">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="email-container" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.06); border: 1px solid #e2e8f0;">
                    ...
                    <!-- Decorative Top Bar -->
                    <tr>
                        <td style="height: 6px; background: linear-gradient(90deg, #7f1d1d 0%, #b91c1c 50%, #ef4444 100%);"></td>
                    </tr>
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 36px 36px 28px 36px;">
                            ...
                            <div style="text-align: left; margin-bottom: 24px;">
                                <div style="display: inline-block; font-size: 11px; font-weight: 700; color: #b91c1c; text-transform: uppercase; letter-spacing: 0.8px; margin-bottom: 6px;">
                                    Pemberitahuan Akun Pengguna
                                </div>
                                <h1 style="margin: 0; font-size: 22px; font-weight: 800; color: #0f172a; line-height: 1.3; letter-spacing: -0.4px;">
                                    Penghapusan Akun SIMON BMN
                                </h1>
                            </div>

                            <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #334155;">
                                Yth. Bapak/Ibu <strong>{{ $userName }}</strong>,
                            </p>

                            <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #475569;">
                                Kami informasikan bahwa akun kedinasan Anda pada aplikasi <strong>SIMON (Sistem Informasi Manajemen BMN)</strong> telah <strong>dihapus</strong> dari sistem oleh administrator/koordinator.
                            </p>
                                    ...
                                    <td style="padding: 16px 20px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 13px; color: #334155;">
                                            <tr>
                                                ...
                                                <td width="62%" style="padding: 5px 0; font-weight: 600; color: #0f172a;">{{ $userName }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Email Terdaftar</td>
                                                <td style="padding: 5px 0; font-weight: 600; color: #0f172a;">{{ $userEmail }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Status</td>
                                                <td style="padding: 5px 0;">
                                                    <span style="display: inline-block; font-size: 11px; font-weight: 700; color: #b91c1c; background-color: #fef2f2; border: 1px solid #fecaca; padding: 3px 10px; border-radius: 6px;">
                                                        Dihapus Permanen
                                                    </span>
                                                </td>
                                            </tr>
                                            @if(!empty($reason))
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b; vertical-align: top;">Alasan Penghapusan</td>
                                                <td style="padding: 5px 0; color: #334155; line-height: 1.4; font-style: italic;">"{{ $reason }}"</td>
                                            </tr>
                                            @endif
                                            @if(!empty($deletedBy))
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Dihapus Oleh</td>
                                                <td style="padding: 5px 0; color: #64748b;">{{ $deletedBy }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Waktu Penghapusan</td>
                            ...
                            <div style="background-color: #f8fafc; border-left: 4px solid #b91c1c; border-radius: 0 8px 8px 0; padding: 14px 16px; margin-bottom: 24px;">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="font-size: 12px; line-height: 1.5; color: #475569;">
                                            <strong>Informasi Pendaftaran Ulang:</strong> Alamat email Anda kini tidak lagi terdaftar pada database sistem. Anda dapat melakukan pendaftaran ulang dengan data kedinasan baru apabila dibutuhkan, atau hubungi Sub Bagian Tata Usaha Balai Gakkum LH Wilayah Sumatera jika terdapat pertanyaan.
                                        </td>
                                    </tr>
                                </table>
                            </div>
